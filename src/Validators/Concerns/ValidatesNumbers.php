...
trait ValidatesNumbers
{
    ...
    protected function validateMinimum(mixed $data, array $schema): bool
    {
        ...
        if ($data < $schema['minimum']) {
            $this->addError('minimum', sprintf('Value %s is less than minimum %s', (string) json_encode($data), (string) json_encode($schema['minimum'])));
    ...
    protected function validateMaximum(mixed $data, array $schema): bool
    {
        ...
        if ($data > $schema['maximum']) {
            $this->addError('maximum', sprintf('Value %s is greater than maximum %s', (string) json_encode($data), (string) json_encode($schema['maximum'])));
