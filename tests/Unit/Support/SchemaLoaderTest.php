...
it('loads schema with fragment', function (): void {
    $loader = new SchemaLoader();
    $schema = $loader->load('http://localhost:1234/draft2020-12/name-defs.json#/$defs/orNull');
...
it('caches base schema when loading with fragment', function (): void {
    ...
    // Load with fragment
    $loader->load('http://localhost:1234/draft2020-12/name-defs.json#/definitions/orNull');
    // Load base schema
    $schema = $loader->load('http://localhost:1234/draft2020-12/name-defs.json');
...
it('resolves fragment with single level', function (): void {
    $loader = new SchemaLoader();
    $schema = $loader->load('http://localhost:1234/draft2020-12/ref-and-defs.json#/$defs');
